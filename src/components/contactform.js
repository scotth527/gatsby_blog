    ...
    <div id="contact">
        <form className="col-lg-6 col-12 mx-auto text-center border border-dark rounded" action="https://formspree.io/scottyh527@gmail.com" method="POST">
            ...
            <div className="col-12 mx-auto d-flex flex-column">
                <label className="mr-auto" for="name">Full Name</label>
                <input className="col-12 mb-3" type="text" name="name" placeholder="Your full name"/>
                <label className="mr-auto" for="exampleInputEmail1">Email address</label>
                <input className="col-12 mb-3 form-control" type="email" name="_replyto" placeholder="Your email"/>
                <label className="mr-auto" for="message">Message</label>
